$(function () {
    let search = window.location.href.split("?")[1].split("=")[1].replace('#', '')
    let params = {
        page: 1,
        size: 9,
    ...
    $('.input-group-btn button[name="handle_search"]').on('click', function() {
        params.keyword = $('.input-group input[name="search_again"]').val()
        getList()
    })
